...
void printSettings() {
  ...
  prntf(FV(SETTING[S_SCALE_TURNING_WHEN_MOVING_BACKWARDS]), SCALE_TURNING_WHEN_MOVING_BACKWARDS);
  ...
  prnt(FV(SETTING[S_INACTIVITY_ALERT_TIMEOUT]), INACTIVITY_ALERT_TIMEOUT);
  ...
  prntbool(FV(SETTING[S_USE_RC_FORCE_STANDARD_MODE_PIN]), USE_RC_FORCE_STANDARD_MODE_PIN);
  prnt(FV(SETTING[S_RC_FORCE_STANDARD_MODE_PIN]), RC_FORCE_STANDARD_MODE_PIN);
